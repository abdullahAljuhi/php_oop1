                ...
                <div class="card mt-5 shadow">
                    ...
                    <div class="card-body">
                        ...
                        <form action="insert.php" method="post" enctype="multipart/form-data">
                            <input type="text" class="form-control mb-3 fs-5" placeholder=" product Name " name="name">
                            <input type="text" class="form-control mb-3 fs-5" placeholder=" description " name="des">
