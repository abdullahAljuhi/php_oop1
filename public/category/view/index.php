                            ...
                            <div class="card h-100">
                                ...
                                <div class="card-footer bg-white">
                                    <div class="row justify-content-around my-3">
                                        <a href="edite.php?categoryld=<?php echo $cateID ?>" class="btn btn-outline-dark col-5">Edit</a>
                                        <a href="delete.php?delcategoryld=<?php echo $cateID ?>" class="btn btn-dark col-5">Delete</a>
                                    </div>
                                </div>
                            </div>
                        </div>
